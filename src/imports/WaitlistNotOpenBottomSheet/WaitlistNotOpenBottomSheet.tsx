...
interface WaitlistNotOpenBottomSheetProps {
  onClose: () => void;
}

const imgPrereqThumb = "/prereq-video-thumb.png";

const WaitlistNotOpenBottomSheet: React.FC<WaitlistNotOpenBottomSheetProps> = ({ onClose }) => {
  return (
    <>
      <style>{`
        @keyframes slideUp {
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", paddingRight: 24, paddingTop: 16, paddingBottom: 4, flexShrink: 0 }}>
          ...
          >
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                <clipPath id="wnoClose"><rect width="24" height="24" fill="white" transform="translate(8 8)"/></clipPath>
              </defs>
            </svg>
          </button>
        </div>
        ...
        {/* Scrollable content */}
        <div style={{ padding: "0 24px 24px 24px", display: "flex", flexDirection: "column", gap: 24, overflowY: "auto", flex: 1 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            <p style={{ margin: 0, fontFamily: "Inter, sans-serif", fontWeight: 700, fontSize: 18, color: "#212121", letterSpacing: "0.15px", lineHeight: 1.25 }}>
              Learn while you wait for live class.
            </p>
            <p style={{ margin: 0, fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: 14, color: "#616161", lineHeight: 1.6, letterSpacing: "0.25px" }}>
              Waitlist is not yet open, you may learn these lessons before the next live class starts.
            </p>
          </div>

          {/* Prerequisites section */}
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <p style={{ margin: 0, fontFamily: "Inter, sans-serif", fontWeight: 600, fontSize: 16, color: "#212121", lineHeight: 1.25 }}>
                ...
                <div style={{ width: 100, height: 58, borderRadius: 4, overflow: "hidden", flexShrink: 0, position: "relative" }}>
                  ...
                  <div style={{ position: "absolute", left: "50%", top: "50%", transform: "translate(-50%, -50%)" }}>
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <defs><clipPath id="wnoPlay"><rect width="40" height="40" fill="white"/></clipPath></defs>
                    </svg>
                  </div>
...
export default WaitlistNotOpenBottomSheet;
