...
interface LearnPrereqsBottomSheetProps {
  onClose: () => void;
  onLeaveWaitlist: () => void;
}

const imgPrereqThumb = "/prereq-video-thumb.png";
const imgTeacherPhoto = "/Teacher photo.png";
const imgLeaveWaitlist = "/Leave waitlist.png";

const LearnPrereqsBottomSheet: React.FC<LearnPrereqsBottomSheetProps> = ({
  onClose,
  onLeaveWaitlist,
}) => {
  return (
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            <p style={{
              ...
              You're on the waitlist. Learn while you wait for live class.
            </p>
            <p style={{
              margin: 0,
              fontFamily: "Inter, sans-serif",
              ...
              Your class starts in 3 days.
            </p>
          </div>

          {/* 2. Teacher's Note card */}
          <div style={{
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 4 }}>
              ...
              <p style={{
                ...
                Finish the below lessons before your live class to make the most of the session.
              </p>
            </div>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 24 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
              ...
              <p style={{ margin: 0, fontFamily: "Inter, sans-serif", fontSize: 12, color: "#616161", lineHeight: 1.4 }}>
                <span style={{ fontWeight: 700 }}>72%</span>
                <span style={{ fontWeight: 400 }}> waitlisted students completed these lessons</span>
              </p>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <div style={{ width: 100, height: 58, borderRadius: 4, overflow: "hidden", flexShrink: 0, position: "relative" }}>
                  ...
                  <div style={{ position: "absolute", left: "50%", top: "50%", transform: "translate(-50%, -50%)" }}>
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <defs><clipPath id="lpbsPlay1"><rect width="40" height="40" fill="white"/></clipPath></defs>
                    </svg>
                  </div>
              ...
              <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                <div style={{ width: 100, height: 58, borderRadius: 4, overflow: "hidden", flexShrink: 0, position: "relative" }}>
                  ...
                  <div style={{ position: "absolute", left: "50%", top: "50%", transform: "translate(-50%, -50%)" }}>
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clipPath="url(#lpbsPlay2)">
                        <path d="M19.9987 3.3335C10.7987 3.3335 3.33203 10.8002 3.33203 20.0002C3.33203 29.2002 10.7987 36.6668 19.9987 36.6668C29.1987 36.6668 36.6654 29.2002 36.6654 20.0002C36.6654 10.8002 29.1987 3.3335 19.9987 3.3335ZM15.832 24.4502V15.5502C15.832 14.2335 17.2987 13.4335 18.3987 14.1502L25.3154 18.6002C26.332 19.2502 26.332 20.7502 25.3154 21.4002L18.3987 25.8502C17.2987 26.5668 15.832 25.7668 15.832 24.4502Z" fill="black" fillOpacity="0.8"/>
                        <path d="M15.832 24.4668V15.5668C15.832 14.2502 17.2987 13.4502 18.3987 14.1668L25.3154 18.6168C26.332 19.2668 26.332 20.7668 25.3154 21.4168L18.3987 25.8668C17.2987 26.5835 15.832 25.7835 15.832 24.4668Z" fill="white"/>
                      </g>
                      <defs><clipPath id="lpbsPlay2"><rect width="40" height="40" fill="white"/></clipPath></defs>
                    </svg>
                  </div>
                  <div style={{ position: "absolute", bottom: 0, left: 0, height: 4, width: "99.429px", backgroundColor: "rgba(0,0,0,0.4)" }} />
                </div>
          ...
          <div style={{
            ...
            {/* Illustration */}
            <div style={{ width: 80, flexShrink: 0, alignSelf: "flex-start", marginTop: 0 }}>
              <img
                alt=""
                src={imgLeaveWaitlist}
                style={{ width: "100%", height: "auto", display: "block" }}
              />
            </div>
            {/* Text + CTA */}
            <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 12, paddingBottom: 4, justifyContent: "center" }}>
              <p style={{
                margin: 0,
                fontFamily: "Inter, sans-serif",
                fontSize: 14,
              ...
              <p style={{
                ...
                Can't make it to the live class? Leave the waitlist so others can take your spot.
              </p>
              <button
...
export default LearnPrereqsBottomSheet;
